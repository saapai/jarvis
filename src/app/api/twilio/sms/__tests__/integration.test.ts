...
describe('SMS Pipeline Integration', () => {
  describe('Intent Classification', () => {
    ...
    it('should not classify attendance questions as drafts (polls removed)', async () => {
      const context: ClassificationContext = {
      ...
      expect(['content_query', 'chat']).toContain(result.action)
      expect(result.subtype).not.toBe('poll')
    })
